...
#define OSHIFTPRINTF(name) case name: o << # name; break;
    ...
    OSHIFTPRINTF(DMT_GET_PARTNER_CKPT_DIR)
    OSHIFTPRINTF(DMT_GET_PARTNER_CKPT_DIR_RESULT)
    OSHIFTPRINTF(DMT_GET_LOCAL_CKPT_DIR)
    OSHIFTPRINTF(DMT_GET_LOCAL_CKPT_DIR_RESULT)
    OSHIFTPRINTF(DMT_UPDATE_GLOBAL_CKPT_DIR)
    OSHIFTPRINTF(DMT_UPDATE_PARTNER_CKPT_DIR)
    OSHIFTPRINTF(DMT_UPDATE_LOCAL_CKPT_DIR)
    ...
    OSHIFTPRINTF(DMT_DO_PRE_SUSPEND)
    OSHIFTPRINTF(DMT_PRE_SUSPEND_RESPONSE)
